 ...
 */
typedef struct {
    const usb_device_match_id_t *match_id_list; /*!< USB device match ID for ECM */
...
/**
 * @brief Get the CDC handle of the RNDIS driver.
 *
 * @param[in] rndis_drv RNDIS Ethernet driver handle
 *
 * @return usbh_cdc_handle_t CDC handle of the RNDIS driver
 */
